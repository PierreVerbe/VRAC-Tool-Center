import { SET_STRATEGY_APP_BAR, SET_STRATEGY_LOADER, SET_FILE_UPLOADED, INSERT_STRATEGY, GET_ALL_STRATEGIES, GET_STRATEGY, UPDATE_STRATEGY, DELETE_STRATEGY, SET_STRATEGY_STEPPER, SET_ID_ROW_STRATEGY_TABLE, SET_STRATEGY, SET_OPEN_DIALOG_STRATEGY, SET_OPEN_DIALOG_NODE_STRATEGY, SET_META_ACTION_ARRAY, SET_OPEN_DIALOG_META_ACTION, SET_STRATEGY_CREATOR } from "../action/strategyAction"

export const strategyReducer = (state, action) => {
    switch (action.type) {

        case SET_STRATEGY_APP_BAR:
            return {
                ...state,
                strategyAppBar: action.payload
            }
