...
const TopArmGaleryBottomAction = ({action, metaActionArray, setMetaActionArray}) => {
...
TopArmGaleryBottomAction.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(TopArmGaleryBottomAction)
