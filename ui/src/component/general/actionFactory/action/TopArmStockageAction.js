...
const TopArmStockageAction = ({action, metaActionArray, setMetaActionArray}) => {
...
TopArmStockageAction.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(TopArmStockageAction)
