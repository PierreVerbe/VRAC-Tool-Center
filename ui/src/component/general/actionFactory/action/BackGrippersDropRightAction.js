...
const BackGrippersDropRightAction = ({ action, metaActionArray, setMetaActionArray }) => {
    const ACTION = "BackGrippersDropRight"
...
BackGrippersDropRightAction.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(BackGrippersDropRightAction)
