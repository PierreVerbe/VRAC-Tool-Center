...
const TopArmPreStockageAction = ({action, metaActionArray, setMetaActionArray}) => {
...
TopArmPreStockageAction.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(TopArmPreStockageAction)
