...
const SingleArmOutAction = ({action, metaActionArray, setMetaActionArray}) => {
    const ACTION = "SingleArmOut"
...
export default connect(mapStateToProps, mapDispatchToProps)(SingleArmOutAction)
