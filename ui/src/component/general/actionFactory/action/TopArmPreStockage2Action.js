...
const TopArmPreStockage2Action = ({action, metaActionArray, setMetaActionArray}) => {
...
TopArmPreStockage2Action.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(TopArmPreStockage2Action)
