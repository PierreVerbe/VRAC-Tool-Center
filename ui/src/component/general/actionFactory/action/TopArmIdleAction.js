...
const TopArmIdleAction = ({action, metaActionArray, setMetaActionArray}) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(TopArmIdleAction)
