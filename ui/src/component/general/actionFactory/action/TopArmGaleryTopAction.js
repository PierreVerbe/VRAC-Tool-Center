...
const TopArmGaleryTopAction = ({action, metaActionArray, setMetaActionArray}) => {
    const ACTION = "TopArmGaleryTop"
...
TopArmGaleryTopAction.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(TopArmGaleryTopAction)
