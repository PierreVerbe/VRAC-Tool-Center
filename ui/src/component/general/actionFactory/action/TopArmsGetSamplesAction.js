...
const TopArmsGetSamplesAction = ({action, metaActionArray, setMetaActionArray}) => {
    const ACTION = "TopArmsGetSamples"
...
TopArmsGetSamplesAction.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(TopArmsGetSamplesAction)
