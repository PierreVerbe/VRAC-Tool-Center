...
const TopArmBuffer1Action = ({action, metaActionArray, setMetaActionArray}) => {
    const ACTION = "TopArmBuffer1"
...
export default connect(mapStateToProps, mapDispatchToProps)(TopArmBuffer1Action)
