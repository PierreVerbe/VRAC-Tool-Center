...
const ActivateBackGripperAutoGrabAction = ({ action, metaActionArray, setMetaActionArray }) => {
    const ACTION = "ActivateBackGripperAutoGrab"
...
ActivateBackGripperAutoGrabAction.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ActivateBackGripperAutoGrabAction)
