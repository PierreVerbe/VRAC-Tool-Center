...
const BottomArmsRetrieveDoubleAction = ({ action, metaActionArray, setMetaActionArray }) => {
...
BottomArmsRetrieveDoubleAction.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(BottomArmsRetrieveDoubleAction)
