...
const SingleArmInAction = ({action, metaActionArray, setMetaActionArray}) => {
    const ACTION = "SingleArmIn"
...
export default connect(mapStateToProps, mapDispatchToProps)(SingleArmInAction)
