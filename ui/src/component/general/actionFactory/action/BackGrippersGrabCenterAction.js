...
const BackGrippersGrabCenterAction = ({ action, metaActionArray, setMetaActionArray }) => {
    const ACTION = "BackGrippersGrabCenter"
...
BackGrippersGrabCenterAction.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(BackGrippersGrabCenterAction)
